...
const metamaskPayload = (payload) => {
    var _a;
    if (Array.isArray(payload.params)) {
        const params = payload.params[0];
        if (params.input && !params.data) {
            return Object.assign(Object.assign({}, payload), { params: [Object.assign(Object.assign({}, params), { data: (_a = params.data) !== null && _a !== void 0 ? _a : params.input })] });
        }
    }
    return payload;
};
class Web3RequestManager extends web3_event_emitter_js_1.Web3EventEmitter {
    ...
    _sendRequest(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((0, utils_js_1.isMetaMaskProvider)(provider)) { // metamask send_transaction accepts data and not input, so we change it
                if (payload.method === 'eth_sendTransaction') {
                    if (!web3_utils_1.jsonRpc.isBatchRequest(payload)) {
